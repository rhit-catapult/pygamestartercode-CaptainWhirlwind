...
class Missile:
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (0,255,45), (self.x, self.y), (self.x+4, self.y +8))
...
class Fighter:
    def __init__(self, screen):
        ...
        self.image.get_colorkey((255, 255, 255))
    ...
    def fire(self):
        ...
        missile = Missile(self.screen, self.x + self.image.get_width()//2)
